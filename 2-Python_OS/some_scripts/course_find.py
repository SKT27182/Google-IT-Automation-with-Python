...
def show_vaccancy(updated_data):
	...
	for key, value in updated_dictionary.items():
		...
		#Passes if both are blank
			...
			print("{k:8} has {v:4} vaccany left".format(k=key,v=value))
		else:
			pass
